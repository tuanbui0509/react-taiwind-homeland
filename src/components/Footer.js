...
const Footer = () => {
  return (
    <footer>
      ...
      <div aria-label="Site Footer" className="bg-white lg:grid lg:grid-cols-5">
          ...
          <div className="pt-12 mt-12 border-t border-gray-100">
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <p className="mt-8 text-xs text-gray-500 sm:mt-0">
                &copy; 2022. HomeLanding <span className='font-semibold'>Tuan Bui</span>. All rights reserved.
              </p>
            </div>
          </div>
        </div>
